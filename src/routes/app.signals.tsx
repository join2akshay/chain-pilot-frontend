        ...
        <div className="flex items-center justify-center min-h-[600px]">
          <div className="flex flex-col items-center gap-4">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-foreground">Analyzing on-chain data</p>
              <p className="text-xs text-muted-foreground mt-1">Fetching signal intelligence...</p>
            </div>
          </div>
        </div>
      ) : (
